		...
		try {
			...
			for (int i = 0; i < 16384; i++) {
				if (i > 0)
					wr.write(",");
				wr.write("{" + UUID.randomUUID() + ","
						+ random.nextInt(4194304) +  "," + random.nextInt(17000) +"}");
			}
			wr.write("\r\n");
			...
			for (int i = 0; i < 65536; i++) {
				if (i > 0)
					wr.write(",");
				wr.write("{" + UUID.randomUUID() + ","
						+ random.nextInt(16777216) +  "," + random.nextInt(66000) +"}");
			}
			wr.write("\r\n");	
			...
			for (int i = 0; i < 262144; i++) {
				if (i > 0)
					wr.write(",");
				wr.write("{" + UUID.randomUUID() + ","
						+ random.nextInt(67108864) +  "," + random.nextInt(263000) +"}");
			}
			wr.write("\r\n");
			////////////////
		} finally {
